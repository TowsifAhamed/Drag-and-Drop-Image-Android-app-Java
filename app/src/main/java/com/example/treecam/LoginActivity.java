...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextInputLayout mphonenumber, mcode;
    ...
    private void verifyphonenumberwithcode(){
        PhoneAuthCredential credential = PhoneAuthProvider.getCredential(mverificationid, mcode.getEditText().getText().toString());
